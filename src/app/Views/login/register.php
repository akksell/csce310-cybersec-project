        ...
        <div>
          ...
          <form action="/register" method="POST" accept-charset="utf-8" class="flex flex-col items-center justify-center items-center gap-y-2 py-8">
            ...
            <div class="flex flex-col gap-4" id="multi-form-page">
              ...
              <div class="relative">
                <input type="text" pattern="[0-9]\.[0-9]{2}" maxlength="4" name="GPA" id="gpa-input" required class="block rounded border border-1 px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
