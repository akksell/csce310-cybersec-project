...
<div class="flex flex-row justify-center">
      ...
      <thead>
         <tr>
            ...
            <th class="border-2 px-2">Student</th>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
            <form action=<?php echo '/event_tracking/destroy/'.$event['ET_Num'];?> method="POST" accept-charset="utf-8" class="flex flex-col items-center justify-center items-center gap-y-2 font-medium text-blue-600 dark:text-blue-500 hover:underline px-1">
